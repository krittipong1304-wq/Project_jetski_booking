...
INSERT INTO `boats` (`id`, `boat_name`, `description`, `image_path`, `is_active`, `is_booked`, `hourly_rate`, `hourly_rate_usd`, `stock`, `created_at`) VALUES
(4, 'Yacht D', '', 'uploads/boats/boat_69a8090f647249.14020504.jpg', 1, 0, 600.00, 60.00, 7, '2026-03-04 10:19:22');
...
INSERT INTO `booking_location_options` (`id`, `option_name`, `price`, `price_usd`, `is_active`, `sort_order`) VALUES
(1, 'Pier A', 999.00, 0.00, 1, 1),
(2, 'Pier B', 0.00, 0.00, 1, 2),
(3, 'Pier C', 0.00, 0.00, 1, 3);
